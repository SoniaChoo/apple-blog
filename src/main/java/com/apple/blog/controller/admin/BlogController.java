...
public class BlogController {
    ...
    public String bolgsSearch(@RequestParam(value = "page", defaultValue = "1") Integer pn, BlogQuery blogQuery, Model model) {
    ...
    @GetMapping("/blogs")
    public String blogs(@RequestParam(value = "pn", defaultValue = "1") Integer pn, BlogQuery blogQuery, Model model) {
        // 先创建blogTypeVO集合
        // 先查询出所有的blogId
